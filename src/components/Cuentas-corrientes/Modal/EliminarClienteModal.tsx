    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-[#1e2736] w-full max-w-md rounded-2xl shadow-2xl border border-neutral-200 dark:border-[#333] overflow-hidden transform transition-all scale-100">
        ...
        <div className="p-6 pb-0 flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 dark:text-white">¿Eliminar Cliente?</h3>
          <div className="mt-2 text-sm text-gray-500 dark:text-gray-400">
            <p className="mb-2">Estás a punto de eliminar a <span className="font-bold text-gray-800 dark:text-gray-200">"{nombreCliente}"</span>.</p>
