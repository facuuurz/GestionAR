...
export default function FormularioPromocion({ actionFunc, initialData }: FormularioPromocionProps) {
  ...
  useEffect(() => {
    if (state.payload && state.payload.productosDataUI) {
      try {
        const productosRestaurados = typeof state.payload.productosDataUI === 'string' 
          ? JSON.parse(state.payload.productosDataUI)
          : state.payload.productosDataUI;
      ...
      <form action={handleSubmit} className="p-6 md:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div className="col-span-1 md:col-span-2 relative" ref={wrapperRef}>
            <label className="block text-sm font-bold text-[#111318] dark:text-gray-200 mb-2">
              Productos Incluidos <span className="text-black dark:text-white">*</span>
            </label>
            
            {/* BUSCADOR */}
            <div className="relative mb-4">
              <div className={`flex items-center bg-[#f8fafa] dark:bg-gray-800 border-2 rounded-lg py-1 px-1 transition-all
                  ${erroresCliente.productos ? 'border-red-500 focus-within:border-red-500 focus-within:ring-red-500/20' : 'border-transparent focus-within:border-[#135bec] focus-within:ring-2 focus-within:ring-[#135bec]/20'}`}>
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <div className="flex items-center bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-lg overflow-hidden">
                          <button 
                            ...
                            className="px-2 py-1.5 text-slate-500 hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors focus:outline-none cursor-pointer"
                          >
          ...
          <div className="col-span-1 md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="col-span-1">
              <label className="block text-sm font-bold text-[#111318] dark:text-gray-200 mb-2" htmlFor="display_price">Precio Promocional Final</label>
              <div className="flex items-center bg-[#f8fafa] dark:bg-gray-800 border-2 border-transparent rounded-lg py-1 px-1 transition-all">
                <div className="flex-shrink-0 h-10 w-10 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 rounded-md flex items-center justify-center ml-1">
            ...
            {/* FECHA INICIO CON COMPONENTE UI */}
            <InputConIcono
              className="col-span-1"
